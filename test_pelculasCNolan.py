...
class TestPelculasCNolan():
  ...
  def test_pelculasCNolan(self):
    ...
    self.driver.find_element(By.ID, "title").send_keys("Oppenheimer")
    self.driver.find_element(By.ID, "description").click()
    self.driver.find_element(By.ID, "description").send_keys("Sobre la vida del físico")
    ...
    actions.move_to_element(element, 0, 0).perform()
    self.driver.find_element(By.ID, "title").click()
    self.driver.find_element(By.ID, "title").send_keys("Dunkerke")
    self.driver.find_element(By.ID, "title").click()
    self.driver.find_element(By.ID, "title").send_keys("Dunkerque")
    self.driver.find_element(By.ID, "description").click()
    self.driver.find_element(By.ID, "description").send_keys("Sobre el escape del ejercito inglés en las costas francesas.")
    self.driver.find_element(By.ID, "year").click()
