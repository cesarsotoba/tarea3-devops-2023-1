...
class TestAgregarPeliculasADirectores():
  ...
  def test_agregarPeliculasADirectores(self):
    ...
    self.driver.find_element(By.ID, "title").send_keys("El código da vinci")
    self.driver.find_element(By.ID, "description").send_keys("película basada en el libro del mismo nombre")
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'Ron Howard']").click()
    ...
    self.driver.find_element(By.ID, "title").click()
    self.driver.find_element(By.ID, "title").click()
    self.driver.find_element(By.ID, "title").send_keys("Napoleón")
    self.driver.find_element(By.ID, "description").click()
    self.driver.find_element(By.ID, "description").send_keys("Sobre la vida del emperador francés")
    self.driver.find_element(By.ID, "year").click()
    self.driver.find_element(By.ID, "year").send_keys("2023")
    self.driver.find_element(By.ID, "director_id").click()
    dropdown = self.driver.find_element(By.ID, "director_id")
    dropdown.find_element(By.XPATH, "//option[. = 'Ridley Scott']").click()
    self.driver.find_element(By.CSS_SELECTOR, ".h-min > .flex").click()
