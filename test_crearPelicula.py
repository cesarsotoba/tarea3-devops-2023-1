...
class TestCrearPelicula():
  ...
  def test_crearPelicula(self):
    ...
    self.driver.find_element(By.ID, "title").click()
    self.driver.find_element(By.ID, "title").send_keys("The Godfather")
    self.driver.find_element(By.ID, "description").click()
    self.driver.find_element(By.ID, "description").send_keys("El padrino 2")
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'francis ford coppola']").click()
